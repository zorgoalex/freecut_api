...
pub struct GroupShiftTelemetry {
    ...
    pub topology_score_before: f64,
    pub topology_score_after: f64,
    pub topology_score_delta: f64,
    pub part_contact_before_mm: f64,
    pub part_contact_after_mm: f64,
    pub part_contact_delta_mm: f64,
